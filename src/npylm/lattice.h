...
namespace npylm {
	...
	public:
		...
		void forward_filtering(Sentence* sentence, bool use_scaling = true);
		void _forward_filtering(Sentence* sentence, double*** alpha, double* scaling, bool use_scaling = true);
		...
		void _blocked_gibbs(Sentence* sentence, std::vector<int> &segments, bool use_scaling = true);
